...
export const TIPS: Tip[] = [
  ...
  // 境图 BoundaryAI 法律场景提示
  { id: 'tip-legal-conflict', text: '输入 /cross-border-legal 启动跨境合规冲突检测流程', platform: 'all' },
  { id: 'tip-legal-upload', text: '支持拖拽上传合同文件（PDF/Word），AI 会自动解析关键条款', platform: 'all' },
  { id: 'tip-legal-report', text: '检测完成后可以一键导出冲突分析报告（Word/PDF）', platform: 'all' },
  { id: 'tip-legal-agent', text: '复杂合规问题建议切换到 Agent 模式，AI 会自主完成多步骤分析', platform: 'all' },
  { id: 'tip-legal-rag', text: '境图 AI 引用法条时会标注来源，点击可查看法条原文', platform: 'all' },
]
